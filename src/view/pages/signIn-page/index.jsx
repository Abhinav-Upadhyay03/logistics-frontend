        ...
        <>
          ...
          <div className="bg-white sm:w-[60%] w-full h-svh ">
              ...
              <div className="p-10 sm:px-20">
                ...
                <div className="sm:mt-10 mt-20 ">
                  <div className="w-full relative">
                    ...
                    <div className="absolute top-[20px] right-2">
                      <div className="relative group ml-2 sm:hidden">
                        ...
                        <div className="hidden w-max group-hover:block absolute top-0 right-5 bg-white z-[99] border border-gray-300 p-2 rounded shadow-md max-w-[50vw] whitespace-normal break-words">
                  ...
                  <div className="mt-4">
                    ...
                    <div
                      className={`relative sm:border-none border-b flex items-baseline justify-between w-full ${errorText === "Invalid identifier or password" && "border-red-400"}`}
                    >
                      <input
                ...
                <div className="text-center py-6 text-xs font-semibold text-red-400">
                  {errorText === "Invalid identifier or password"
                    ? "Invalid Credentials"
                    : errorText}
                </div>
              </div>
            ...
            <div className="text-center sm:mt-20">
              <p
                className="text-[#3AB7FC] cursor-pointer pt-6 sm:pt-0"
